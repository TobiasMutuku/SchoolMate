    ...
    public partial class frmBookReturn : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                con = new SqlConnection(cs.ReadfromXML());
                con.Open();
                string cb = "insert into Return_Student(IssueID,ReturnDate,Fine,Remarks) VALUES (@d2,@d3,@d4,@d5)";
        ...
        private void btnUpdate_record_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                con = new SqlConnection(cs.ReadfromXML());
                con.Open();
                string cb = "Update Return_Student set IssueID=@d2,ReturnDate=@d3,Fine=@d4,Remarks=@d5 where ReturnID=" + txtID.Text + "";
                cmd = new SqlCommand(cb);
                cmd.Parameters.AddWithValue("@d2", txtIssueID_Student.Text);
                cmd.Parameters.AddWithValue("@d3", dtpReturnDate.Value.Date);
                cmd.Parameters.AddWithValue("@d4", txtFine.Text);
        ...
        private void btnUpdate1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string cb = "Update Return_Staff set IssueID=@d2,ReturnDate=@d3,Fine=@d4,Remarks=@d5 where ID=" + txtID1.Text + "";
                cmd = new SqlCommand(cb);
        ...
        {
           frmBookIssueListStudent frm = new frmBookIssueListStudent(this);
            frm.lblSET.Text = "BR";
            frm.Show();
        }
        private void func()
        ...
        {
            frmBookIssueListStaff frm = new frmBookIssueListStaff(this);
            frm.lblSET.Text = "BR";
            frm.Show();
        }
        ...
        {
            frmBooksReturnListStaff frm = new frmBooksReturnListStaff(this);
            frm.lblSET.Text = "BR";
        ...
        {
           frmBookReturnListStudent frm = new frmBookReturnListStudent(this);
            frm.lblSET.Text = "BRS";
            frm.lblUser.Text = lblUser.Text;
            frm.ShowDialog();
        }
