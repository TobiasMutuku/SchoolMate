...
{
    public partial class frmStaffBooksFineReport : Form
    {
        ...
        public frmStaffBooksFineReport()
        {
            InitializeComponent();
        }
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Close();
                ds.Tables.Add(table);
                ds.WriteXmlSchema("ReturnFineEmployee.xml");
                RptBooksFineStaff rpt = new RptBooksFineStaff();
