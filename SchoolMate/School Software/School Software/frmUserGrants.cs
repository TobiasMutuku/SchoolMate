...
namespace School_Software
{
    public partial class frmUserGrants : Form
    {
        ...
        private void forms()
        {
            ...
            this.dgvSelectAll.Rows.Add("Student BusHolder Entry");
            this.dgvSelectAll.Rows.Add("Student Discount View");
          
            this.dgvSelectAll.Rows.Add("Library View");
            ...
            this.dgvSelectAll.Rows.Add("Examination View");
            this.dgvSelectAll.Rows.Add("Examination Schedule");
           
            this.dgvSelectAll.Rows.Add("Employee All");
            this.dgvSelectAll.Rows.Add("Employee Registration");
            this.dgvSelectAll.Rows.Add("Employee Discount");
            this.dgvSelectAll.Rows.Add("Payroll All");
           
            this.dgvSelectAll.Rows.Add("Employee Attendance");
            this.dgvSelectAll.Rows.Add("Employee Advance Payment");
            this.dgvSelectAll.Rows.Add("Salary Payment");
            
            this.dgvSelectAll.Rows.Add("Transaction All");
            this.dgvSelectAll.Rows.Add("School Fees Payment");
            this.dgvSelectAll.Rows.Add("Hostel Fees Payment");
            this.dgvSelectAll.Rows.Add("Bus Fees Payment Student");
            this.dgvSelectAll.Rows.Add("Bus Fees Payment Staff");
            ...
            this.dgvSelectAll.Rows.Add("View School Fees List");
            this.dgvSelectAll.Rows.Add("View School Fees Payment List");
            this.dgvSelectAll.Rows.Add("View Hosteler List");

            this.dgvSelectAll.Rows.Add("View Hostel Fees Payment List");

            this.dgvSelectAll.Rows.Add("View Bus Holder Student List");
            this.dgvSelectAll.Rows.Add("View Bus Fees Payment List Student");
            this.dgvSelectAll.Rows.Add("View Bus Holder Staff List");
            this.dgvSelectAll.Rows.Add("View Bus Fees Payment List Staff");
            this.dgvSelectAll.Rows.Add("View Due List");
            this.dgvSelectAll.Rows.Add("View Employee Attendance List");
            this.dgvSelectAll.Rows.Add("View Employee Advance Payment List");
            this.dgvSelectAll.Rows.Add("View Salary Payment List");
            ...
            this.dgvSelectAll.Rows.Add("View Subject List");
            this.dgvSelectAll.Rows.Add("View Exam Schedule List");
