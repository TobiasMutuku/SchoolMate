    ...
    public partial class frmBooksFineStudentReports : Form
    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MyCommand.Parameters.Add("@d1", SqlDbType.DateTime, 30, "ReturnDate").Value = dtpDateFrom.Value.Date;
                MyCommand.Parameters.Add("@d2", SqlDbType.DateTime, 30, "ReturnDate").Value = dtpDateTo.Value.Date;
